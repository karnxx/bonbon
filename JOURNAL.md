---
title: "Project BonBon"
author: "karnxx"
description: "i will attempt at making a bonbon animatronic."
created_at: "2026-3-21"
---

# March 20 2026: Started making the eyeball
- so today i started making the eyeball, since im gonna make the eye system, then the mouth and then ears, then neck and etc. the eyeball is pretty simple, its smtn like [this](https://youtube.com). so i have to custom design the eye and the adapter. this system is very effective, and compact. 
...
# March 22 2026: Remade the socket thing for eyeball
...
- now ill set it to print and update the results here
- ok so it fits nice, and is easy to remove and all. then uhh themiddle part just needs to be sanded and the upper part is hard to put in, so ill have to fix that. shud be rlly quick, i dont think i need to record lapse.
...
# April 24 2026: END
- aight so like ive made a tutorial, which is like low qual-ish but it gets the job done. ive also fixed some parts, added tolerances and all as well. this took ALOTTA time, as fusion stopped working in my laptop, so i had to use web, and i cudnt get the stp or other file, it gets sent to my gmail. i didnt rec with lapse tho this time.
**Total time spent: 300 mins**
